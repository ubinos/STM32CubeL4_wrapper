if(INCLUDE__STM32CUBEL4)
	...
	if(STM32CUBEL4__USE_HAL_DRIVER)
		...
		set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/Drivers/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal_sai.c)
		...
		if(STM32CUBEL4__USE_WM8994)
			set(PROJECT_SOURCES ${PROJECT_SOURCES} ${_tmp_source_dir}/Drivers/BSP/Components/wm8994/wm8994.c)
		endif(STM32CUBEL4__USE_WM8994)
